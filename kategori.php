        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <a href="kategoritambah.php" class="btn btn-primary mb-3"><i class="fa fa-plus"></i> Tambah Data Kategori</a>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <a type="button" data-toggle="tooltip" data-placement="top" title="Edit" href="kategoriedit.php?id_kategori=<?php echo $data['id_kategori']; ?>" class="btn btn-success btn-sm mb-2"><i class="fa fa-edit"></i></a>
                                                <a type="button" data-toggle="tooltip" data-placement="top" title="Hapus" href="kategoridelete.php?id_kategori=<?php echo $data['id_kategori']; ?>" class="btn btn-danger btn-sm mb-2" onclick="return confirm ('Anda Yakin Akan Menghapus Data Kategori Ini?')"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
