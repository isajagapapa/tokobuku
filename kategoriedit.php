        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="kategori_edit.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="nama_kategori" class="form-control" placeholder="Nama Kategori" value="<?php echo $item["nama_kategori"] ?>" required>
                                </div>
                            </div>
