        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="penerbit_edit.php" method="POST" enctype="multipart/form-data">

                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">ID Penerbit</label>
                                <div class="col-md-9">
                                    <input type="text" name="id_penerbit" class="form-control" value="<?php echo $id_penerbit ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="nama_penerbit" class="form-control" placeholder="Nama Penerbit" value="<?php echo $item['nama_penerbit'] ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Alamat</label>
                                <div class="col-md-9">
                                    <input type="text" name="alamat_penerbit" class="form-control" placeholder="Alamat Penerbit" value="<?php echo $item['alamat_penerbit'] ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Email</label>
                                <div class="col-md-9">
                                    <input type="text" name="email_penerbit" class="form-control" placeholder="Email Penerbit" value="<?php echo $item['email_penerbit'] ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Nomor Telepon</label>
                                <div class="col-md-9">
                                    <input type="text" name="telp_penerbit" class="form-control" placeholder="Nomor Telepon" value="<?php echo $item['telp_penerbit'] ?>" required>
                                </div>
                            </div>
