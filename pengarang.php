            ...
            <div id="content" class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Tabel Data Pengarang</h6>
                    </div>
                    <div class="card-body">
                        <a href="pengarangtambah.php" class="btn btn-primary mb-3"><i class="fa fa-plus"></i> Tambah Data Pengarang</a>
                        <div class="table-responsive">
                            <table id="tabelBuku" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT * FROM pengarang where deleted=0";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $data['alamat_pengarang']; ?></td>
                                            <td><?php echo $data['email_pengarang']; ?></td>

                                            <td style="text-align: center;">
                                                <a type="button" data-toggle="tooltip" data-placement="top" title="Edit" href="pengarangedit.php?id_pengarang=<?php echo $data['id_pengarang']; ?>" class="btn btn-success btn-sm mb-2"><i class="fa fa-edit"></i></a>
                                                <a type="button" data-toggle="tooltip" data-placement="top" title="Hapus" href="pengarangdelete.php?id_pengarang=<?php echo $data['id_pengarang']; ?>" class="btn btn-danger btn-sm mb-2" onclick="return confirm ('Anda Yakin Akan Menghapus Data Pengarang Ini?')"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
