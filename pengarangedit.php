        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="container-fluid">
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Data Pengarang</li>
                        </ol>
                    </nav>
                </div>
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="pengarang_edit.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">ID Pengarang</label>
                                <div class="col-md-9">
                                    <input type="text" name="id_pengarang" class="form-control" value="<?php echo $id_pengarang ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Nama Pengarang</label>
                                <div class="col-md-9">
                                    <input type="text" name="nama_pengarang" class="form-control" placeholder="Nama Pengarang" value="<?php echo $item['nama_pengarang'] ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Alamat</label>
                                <div class="col-md-9">
                                    <input type="text" name="alamat_pengarang" class="form-control" placeholder="Alamat Pengarang" value="<?php echo $item['alamat_pengarang'] ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Email</label>
                                <div class="col-md-9">
                                    <input type="text" name="email_pengarang" class="form-control" placeholder="Email Pengarang" value="<?php echo $item['email_pengarang'] ?>" required>
                                </div>
                            </div>
